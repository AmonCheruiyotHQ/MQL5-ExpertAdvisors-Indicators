...
//|                                                                  |
//+------------------------------------------------------------------+
input SystemType SType=0; // Trading Sytem applied (FX or Crypto)
int SysChoice;
...
input int            TslTriggerPointsInput  = 15; // Points in profit before Trailing SL is activated (10 points = 1pip)
